...
namespace CapeCode.StateMachine.Interfaces {
    public interface ITransitionDefinition<TStatefulElement, TStateMachineDefinition, TStateMachineInstance, TStateDefinition, TTransitionDefinition, TVariableDefinition, TVariableInstance>
        ...
        int Priority { get; }
        TStateDefinition StateDefinitionStart { get; set; }
        TStateDefinition StateDefinitionEnd { get; set; }
    }
}
