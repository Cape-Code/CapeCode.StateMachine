...
namespace CapeCode.StateMachine {
    public class StateMachineController<TTransitionLogicController, TStateMachineDataController, TStatefulElement, TStateMachineDefinition, TStateMachineInstance, TStateDefinition, TTransitionDefinition, TVariableDefinition, TVariableInstance, TTransitionExecutionInput, TTransitionFilter>
        ...
        protected virtual void LogException( TStateMachineInstance stateMachineInstance, TTransitionDefinition transitionDefinition, LogLevel level, string methodName, string exceptionDetails, TTransitionExecutionInput transitionExecutionInput ) {
            _logger.Log( level: level, message: TransitionDisplayedName + " \"" + transitionDefinition.Name + "\" for " + StatefulElementDisplayedName + " \"" + stateMachineInstance.StatefulElement.DisplayedName + "\" failed with exception: " + exceptionDetails );
